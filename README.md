...
```gradle
implementation 'net.lachlanmckee:hilt-compose-navigation-factory:1.0.2'
annotationProcessor 'net.lachlanmckee:hilt-compose-navigation-factory-compiler:1.0.2'
```
